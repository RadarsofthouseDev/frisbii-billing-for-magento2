...
class OrderConfirmTemplate implements \Magento\Framework\Option\ArrayInterface
{
    /**
    ...
    {
        return $this->templateSource->setPath('billwerk_subscription_order_confirmation')->toOptionArray();
    }
}
